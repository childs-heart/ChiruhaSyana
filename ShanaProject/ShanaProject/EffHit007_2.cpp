...
CEffHit007_2::CEffHit007_2( CResBattle *game, CShanaProt *target ):CSprite( game )
{
	// 資源調達
	m_Anime.m_AnimeSpec	= game->m_AnimationManager->GetAnimation( ANIME_NO_EFF_HIT_007_2 );
...
CEffHit007_2::~CEffHit007_2()
{
	m_Game->m_DispObjGroup->FreeDispObj( m_DispObj );
}

bool CEffHit007_2::Move()
{
	// **フレ経過で終了
	m_Flame++;
	if( m_Flame == 27 ){
...
bool CEffHit007_2::Draw( CD3DDraw *draw )
{
	CTexture	*tex;
