...
CChaEndan::CChaEndan( CResBattle *game, CShanaProt *target, CCommonData *common ):CSprite( game )
{
	// 資源調達
	m_Anime.m_AnimeSpec	= game->m_AnimationManager->GetAnimation( ANIME_NO_SYS_ENDAN );
...
bool CChaEndan::Draw( CD3DDraw *draw )
{
	CTexture	*tex;
