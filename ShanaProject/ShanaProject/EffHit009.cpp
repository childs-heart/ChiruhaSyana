...
CEffHit009::CEffHit009( CResBattle *game, CShanaProt *target ):CSprite( game )
{
	// 資源調達
	m_Anime.m_AnimeSpec	= game->m_AnimationManager->GetAnimation( ANIME_NO_EFF_HIT_009 );
...
bool CEffHit009::Draw( CD3DDraw *draw )
{
	CTexture	*tex;
