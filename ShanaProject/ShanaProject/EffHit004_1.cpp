...
CEffHit004_1::CEffHit004_1( CResBattle *game, CShanaProt *target ):CSprite( game )
{
	// 資源調達
	m_Anime.m_AnimeSpec	= game->m_AnimationManager->GetAnimation( ANIME_NO_EFF_HIT_004_1 );
...
CEffHit004_1::~CEffHit004_1()
{
	m_Game->m_DispObjGroup->FreeDispObj( m_DispObj );
}

bool CEffHit004_1::Move()
{
	// **フレ経過で終了
	m_Flame++;
	if( m_Flame == 21 ){
...
bool CEffHit004_1::Draw( CD3DDraw *draw )
{
	CTexture	*tex;
